...
const translations = {
  en: {
    ...
    pushOn: "Alert me when this zone turns Critical, or before it does",
    pushOff: "Stop alerts for this zone",
    pushTest: "Send a test notification",
    pushOnNote: "You'll get a notification when this zone reaches Critical, or up to 3 hours earlier if the rain forecast says it will, even with this page closed. At most one alert per zone every 6 hours.",
  ...
  hi: {
    ...
    pushOn: "यह क्षेत्र गंभीर होने पर, या उससे पहले, मुझे सूचित करें",
    pushOff: "इस क्षेत्र की सूचनाएँ बंद करें",
    pushTest: "परीक्षण सूचना भेजें",
    pushOnNote: "यह क्षेत्र गंभीर स्तर पर पहुँचने पर, या वर्षा पूर्वानुमान के अनुसार उससे 3 घंटे पहले तक, आपको सूचना मिलेगी, भले ही यह पेज बंद हो। हर क्षेत्र के लिए 6 घंटे में अधिकतम एक सूचना।",
